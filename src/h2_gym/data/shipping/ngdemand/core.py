...
class NGDemand:
    ...
    def __init__(self, country, data: Optional[str], unit:str = 'TJ', period: Optional[str] = None, 
    ...
    @staticmethod
    def get_data(data: str, path: Optional[str], country: str, unit: str, period) -> pd.DataFrame:
        """
        ...
        if path is None:
            path = Path(__file__).parent / f"demand/src/data/analyzed/{period}_demand_clean.csv"
