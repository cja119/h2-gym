...
class KalmanFilter:
    ...
    def plot_synth(self, sims):
        ...
        plt.plot(self._data.index, self._data, label='Train Data', color='blue')
    ...
    def plot(self):
        ...
        plt.style.use('bmh')
        plt.figure(figsize=(20, 6))
        plt.plot(self._train_data.index, self._train_data, label='Train Data', color='blue')
        plt.plot(self._test_data.index[:12], self._test_data[:12], label='Test Data', color='green')
