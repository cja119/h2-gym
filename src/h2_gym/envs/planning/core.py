...
class Planning:
    def __init__(self, uniqe_idx: str, weather_file: str, parameters: Optional[str] = None) :
        """
    ...
    def __exit__(self, exc_type, exc_value, traceback) -> None:
        ...
        self._model = H2Planning(self._parameters,key = self._idx, filename =  self._weather_file, filepath=None)
        return None
